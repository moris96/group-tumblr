...
export default function NavBar(props){
  ...
  return(
    <div className="navBarContainer">
      ...
      <Popup trigger={<button className="post-button"><img className="post-icon" src="https://www.pngkit.com/png/detail/436-4368614_png-file-new-post-icon-png.png" alt="post" /></button>} modal><PostOptions user={props.user}/></Popup>
    </div>
    )
}